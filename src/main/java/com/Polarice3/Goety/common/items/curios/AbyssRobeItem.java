...
public class AbyssRobeItem extends SingleStackItem {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext,
        ...
        map.put(NeoForgeMod.SWIM_SPEED.get(), new AttributeModifier(UUID.fromString("7f56e408-afa5-4ea3-a0f4-6f27513f207c"), "Abyss Robe Buff", 0.5F, AttributeModifier.Operation.ADDITION));
