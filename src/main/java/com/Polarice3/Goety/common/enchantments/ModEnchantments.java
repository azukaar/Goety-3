...
public class ModEnchantments {
    ...
    public static final DeferredHolder<Enchantment, Enchantment> SOUL_EATER = ENCHANTMENTS.register("soul_eater",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 5, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxSoulEaterLevel, 0), 5, 9, 20, 9, 1, EquipmentSlotGroup.MAINHAND));

    public static final DeferredHolder<Enchantment, Enchantment> WANTING = ENCHANTMENTS.register("wanting",
            id -> simple(id, tag(ItemTags.DURABILITY_ENCHANTABLE), 2, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxWantingLevel, 0), 1, 10, 16, 10, 1, EquipmentSlotGroup.MAINHAND));

    public static final DeferredHolder<Enchantment, Enchantment> POTENCY = ENCHANTMENTS.register("potency",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 2, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxPotencyLevel, 0), 15, 9, 65, 9, 1, EquipmentSlotGroup.MAINHAND));

    public static final DeferredHolder<Enchantment, Enchantment> RADIUS = ENCHANTMENTS.register("radius",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 2, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxRadiusLevel, 0), 12, 20, 37, 20, 1, EquipmentSlotGroup.MAINHAND));

    public static final DeferredHolder<Enchantment, Enchantment> BURNING = ENCHANTMENTS.register("burning",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 1, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxBurningLevel, 0), 10, 10, 30, 10, 1, EquipmentSlotGroup.MAINHAND));

    public static final DeferredHolder<Enchantment, Enchantment> RANGE = ENCHANTMENTS.register("range",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 10, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxRangeLevel, 0), 1, 10, 16, 10, 1, EquipmentSlotGroup.MAINHAND));
    ...
    public static final DeferredHolder<Enchantment, Enchantment> MAGNET = ENCHANTMENTS.register("magnet",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 1, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxMagnetLevel, 0), 10, 8, 30, 8, 1, EquipmentSlotGroup.MAINHAND));

    public static final DeferredHolder<Enchantment, Enchantment> DURATION = ENCHANTMENTS.register("duration",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 5, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxDurationLevel, 0), 10, 8, 30, 8, 1, EquipmentSlotGroup.MAINHAND));

    public static final DeferredHolder<Enchantment, Enchantment> VELOCITY = ENCHANTMENTS.register("velocity",
            id -> simple(id, tag(ItemTags.WEAPON_ENCHANTABLE), 5, com.Polarice3.Goety.utils.ConfigHelper.getInt(SpellConfig.MaxVelocityLevel, 0), 10, 8, 30, 8, 1, EquipmentSlotGroup.MAINHAND));
}