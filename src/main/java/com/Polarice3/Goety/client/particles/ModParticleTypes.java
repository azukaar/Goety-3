...
public class ModParticleTypes {
    public static DeferredRegister<ParticleType<?>> PARTICLE_TYPES = DeferredRegister.create(NeoForgeRegistries.PARTICLE_TYPES, Goety.MOD_ID);
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<SparkleParticleOption>> SPARKLE = PARTICLE_TYPES.register("sparkle",
            () -> new GoetyParticleType<>(false, SparkleParticleOption.CODEC, SparkleParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<DustCloudParticleOption>> DUST_CLOUD = PARTICLE_TYPES.register("dust_cloud",
            () -> new GoetyParticleType<>(false, DustCloudParticleOption.CODEC, DustCloudParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<ShockwaveParticleOption>> SHOCKWAVE = PARTICLE_TYPES.register("shockwave",
            () -> new GoetyParticleType<>(false, ShockwaveParticleOption.CODEC, ShockwaveParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<CircleExplodeParticleOption>> CIRCLE_EXPLODE = PARTICLE_TYPES.register("circle_explode",
            () -> new GoetyParticleType<>(false, CircleExplodeParticleOption.CODEC, CircleExplodeParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<AoEParticleOption>> AOE_INDICATOR = PARTICLE_TYPES.register("aoe_indicator",
            () -> new GoetyParticleType<>(false, AoEParticleOption.CODEC, AoEParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<FoggyCloudParticleOption>> FOG_CLOUD = PARTICLE_TYPES.register("fog_cloud",
            () -> new GoetyParticleType<>(false, FoggyCloudParticleOption.CODEC, FoggyCloudParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<PulsatingCircleParticleOption>> MINE_PULSE = PARTICLE_TYPES.register("mine_pulse",
            () -> new GoetyParticleType<>(false, PulsatingCircleParticleOption.CODEC, PulsatingCircleParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<RisingCircleParticleOption>> SOUL_HEAL = PARTICLE_TYPES.register("soul_heal",
            () -> new GoetyParticleType<>(false, RisingCircleParticleOption.CODEC, RisingCircleParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<ModShriekParticleOption>> MOD_SHRIEK = PARTICLE_TYPES.register("mod_shriek",
            () -> new GoetyParticleType<>(false, ModShriekParticleOption.CODEC, ModShriekParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<SculkBubbleParticleOption>> SCULK_BUBBLE = PARTICLE_TYPES.register("sculk_bubble",
            () -> new GoetyParticleType<>(false, SculkBubbleParticleOption.CODEC, SculkBubbleParticleOption.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<WindParticleOption>> WIND = PARTICLE_TYPES.register("wind",
            () -> new GoetyParticleType<>(false, WindParticleOption.CODEC, WindParticleOption.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<WindBlowParticle.Option>> WIND_BLOW = PARTICLE_TYPES.register("wind_blow",
            () -> new GoetyParticleType<>(false, WindBlowParticle.Option.CODEC, WindBlowParticle.Option.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<WindShockwaveParticle.Option>> WIND_SHOCKWAVE = PARTICLE_TYPES.register("wind_shockwave",
            () -> new GoetyParticleType<>(false, WindShockwaveParticle.Option.CODEC, WindShockwaveParticle.Option.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<GatherTrailParticle.Option>> GATHER_TRAIL = PARTICLE_TYPES.register("gather_trail",
            () -> new GoetyParticleType<>(false, GatherTrailParticle.Option.CODEC, GatherTrailParticle.Option.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<GatherFrostParticle.Option>> FROST_GATHER = PARTICLE_TYPES.register("frost_gather",
            () -> new GoetyParticleType<>(false, GatherFrostParticle.Option.CODEC, GatherFrostParticle.Option.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<AuraParticle.Option>> AURA = PARTICLE_TYPES.register("aura",
            () -> new GoetyParticleType<>(false, AuraParticle.Option.CODEC, AuraParticle.Option.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<GroundAuraParticle.Option>> GROUND_AURA = PARTICLE_TYPES.register("ground_aura",
            () -> new GoetyParticleType<>(false, GroundAuraParticle.Option.CODEC, GroundAuraParticle.Option.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<VerticalCircleExplodeParticleOption>> VERTICAL_CIRCLE_EXPLODE = PARTICLE_TYPES.register("vertical_circle_explode",
            () -> new GoetyParticleType<>(false, VerticalCircleExplodeParticleOption.CODEC, VerticalCircleExplodeParticleOption.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<AbsorbTrailParticleOption>> ABSORB_TRAIL = PARTICLE_TYPES.register("absorb_trail",
            () -> new GoetyParticleType<>(false, AbsorbTrailParticleOption.CODEC, AbsorbTrailParticleOption.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<MagicSmokeParticle.Option>> MAGIC_SMOKE = PARTICLE_TYPES.register("magic_smoke",
            () -> new GoetyParticleType<>(false, MagicSmokeParticle.Option.CODEC, MagicSmokeParticle.Option.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<MagicAshSmokeParticle.Option>> MAGIC_ASH_SMOKE = PARTICLE_TYPES.register("magic_ash_smoke",
            () -> new GoetyParticleType<>(false, MagicAshSmokeParticle.Option.CODEC, MagicAshSmokeParticle.Option.STREAM_CODEC));

    public static final DeferredHolder<ParticleType<?>, ParticleType<FollowFireParticle.Option>> FOLLOW_CULT_SPELL = PARTICLE_TYPES.register("follow_cult_spell",
            () -> new GoetyParticleType<>(false, FollowFireParticle.Option.CODEC, FollowFireParticle.Option.STREAM_CODEC));
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<SpirallingParticleOption>> SPIRALLING = PARTICLE_TYPES.register("spiralling",
            () -> new GoetyParticleType<>(false, SpirallingParticleOption.CODEC, SpirallingParticleOption.STREAM_CODEC));
}
